...
- [ ] **T002** Initialize backend FastAPI project with Poetry
...
- [ ] **T003** Initialize frontend Next.js 14 project
...
- [ ] **T005** Create shared types package structure
...
- [ ] **T005A** [P] Generate TypeScript types from API contracts
...
- [ ] **T005B** [P] Generate TypeScript types for domain entities
...
- [ ] **T006** [P] Configure backend linting
...
- [ ] **T007** [P] Configure frontend linting
...
- [ ] **T008** [P] Setup PostgreSQL database schemas
...
- [ ] **T009** [P] Setup Redis connection configuration
...
- [ ] **T010** Configure Docker Compose for local development
...
- [ ] **T011** [P] Setup Alembic migrations
...
- [ ] **T012** [P] Configure Vercel deployment settings
...
- [ ] **T013** [P] Setup GitHub Actions CI/CD
...
- [ ] **T014** [P] Create environment variables template
...
- [ ] **T015** Configure CORS middleware
...
- [ ] **T016** Setup OpenAPI documentation route
      - **Path**: backend/src/main.py
...
- [ ] **T017** [P] Initialize pytest configuration
...
- [ ] **T018** [P] Initialize Jest and React Testing Library
...
- [ ] **T019** [P] Initialize Playwright E2E tests
...
- [ ] **T020** Create database seed script structure
...
- [ ] **T020A** [P] Seed Languages table with 3 languages
...
- [ ] **T020B** [P] Seed Currencies table with 8 currencies
...
- [ ] **T020C** [P] Seed Locales table with 3 locales
...
- [ ] **T021** [P] Contract test GET /v1/languages
...
- [ ] **T022** [P] Contract test POST /v1/languages/detect
...
- [ ] **T023** [P] Contract test GET /v1/content/{lang}/{slug}
...
- [ ] **T024** [P] Contract test GET /v1/content/{lang}
...
- [ ] **T025** [P] Contract test GET /v1/currencies
...
- [ ] **T026** [P] Contract test POST /v1/currencies/convert
...
- [ ] **T027** [P] Contract test GET /v1/user/preferences
...
- [ ] **T028** [P] Contract test PUT /v1/user/preferences
...
- [ ] **T029** [P] Integration test language detection flow
...
- [ ] **T030** [P] Integration test content fetching with fallback
...
- [ ] **T031** [P] Integration test currency conversion
...
- [ ] **T032** [P] Integration test user preferences persistence (Redis)
...
- [ ] **T033** [P] Integration test URL redirect creation (301)
...
- [ ] **T034** [P] Integration test content archival (410)
...
- [ ] **T035** [P] Integration test multi-language content retrieval
...
- [ ] **T036** [P] Integration test hreflang generation
...
- [ ] **T037** [P] Integration test slug uniqueness validation
...
- [ ] **T038** [P] Integration test session management
...
- [ ] **T039** [P] Integration test CMS webhook handling
...
- [ ] **T040** [P] Integration test API versioning
...
- [ ] **T041** [P] E2E test language detection and prompt (Playwright)
      ...
      - **→ Validation**: Test fails (language detection component not implemented)

- [ ] **T042** [P] E2E test manual language switching (Playwright)
      - **Path**: frontend/tests/e2e/language-switcher.spec.ts
      ...
      - **→ Validation**: Test fails (LanguageSwitcher component not implemented)

- [ ] **T043** [P] E2E test RTL layout for Hebrew (Playwright)
      ...
      - **→ Validation**: Test fails (RTL layout not implemented)

- [ ] **T044** [P] E2E test currency selection (Playwright)
      - **Path**: frontend/tests/e2e/currency-selector.spec.ts
      - **→ Reference**: quickstart.md:150-168 (Test 3: Currency Selection & Persistence)
      - **Scenario**: Visit /it → verify prices in EUR (27,50 €) → select USD → verify prices update ($29.99) → switch to /il → verify USD persists
      - **→ Validation**: Test fails (CurrencySelector component not implemented)

- [ ] **T045** [P] E2E test SEO meta tags validation (Playwright)
      - **Path**: frontend/tests/e2e/seo-validation.spec.ts
      ...
      - **→ Validation**: Test fails (SEO components not implemented)

- [ ] **T046** [P] E2E test URL redirects (301/410) (Playwright)
      ...
      - **→ Validation**: Test fails (redirect middleware not implemented)

- [ ] **T047** [P] E2E test content fallback to English (Playwright)
      ...
      - **→ Validation**: Test fails (fallback notice component not implemented)

- [ ] **T048** [P] Component test LanguageSwitcher
...
- [ ] **T049** [P] Component test CurrencySelector
...
- [ ] **T050** [P] Component test LanguagePrompt
      ...
      - **→ Validation**: Test fails (LanguagePrompt component not implemented)
...
- [ ] **T051** [P] Migration create languages table
...
- [ ] **T052** [P] Migration create content tables
...
- [ ] **T053** [P] Migration create content_versions table
...
- [ ] **T054** [P] Migration create url_routes and url_redirects
...
- [ ] **T055** [P] Migration create currencies table
...
- [ ] **T056** [P] Migration create user_preferences table
...
- [ ] **T057** [P] Migration create locales table
...
- [ ] **T057A** Validate database schema integrity [CHECKPOINT]
...
- [ ] **T058A** [P] Implement Language validation rules
...
- [ ] **T060A** [P] Implement ContentVersion validation rules
...
- [ ] **T061A** [P] Implement URLRoute validation rules
...
- [ ] **T064A** Validate all entity business rules [CHECKPOINT]
...
- [ ] **T065** [P] Language model (SQLAlchemy)
...
- [ ] **T066** [P] Content model (SQLAlchemy)
...
- [ ] **T067** [P] ContentVersion model (SQLAlchemy)
...
- [ ] **T068** [P] URLRoute model (SQLAlchemy)
...
- [ ] **T069** [P] Currency model (SQLAlchemy)
...
- [ ] **T070** [P] UserPreferences model (SQLAlchemy)
...
- [ ] **T071** [P] Locale model (SQLAlchemy)
...
- [ ] **T072** [P] ILanguageRepository interface
...
- [ ] **T073** [P] IContentRepository interface
...
- [ ] **T074** [P] ICurrencyRepository interface
...
- [ ] **T075** [P] IUserPreferencesRepository interface
...
- [ ] **T076** [P] ICacheService interface
...
- [ ] **T077** [P] ICMSRepository interface
...
- [ ] **T078** [P] IURLRouteRepository interface
...
- [ ] **T079** [P] LanguageRepository (PostgreSQL)
...
- [ ] **T080** [P] ContentRepository (PostgreSQL)
...
- [ ] **T081** [P] CurrencyRepository (PostgreSQL)
...
- [ ] **T082** [P] UserPreferencesRepository (PostgreSQL)
...
- [ ] **T083A** [P] Implement cache fallback logic
...
- [ ] **T085** [P] URLRouteRepository (PostgreSQL)
...
- [ ] **T085A** Verify all repositories implement interfaces [CHECKPOINT]
...
- [ ] **T086** [P] GetAllLanguages use case
...
- [ ] **T087** [P] DetectUserLanguage use case
...
- [ ] **T088** [P] GetLocalizedContent use case
...
- [ ] **T089** [P] ListContentByLanguage use case
...
- [ ] **T090** [P] GetAllCurrencies use case
...
- [ ] **T091** [P] ConvertCurrency use case
...
- [ ] **T092** [P] GetUserPreferences use case
...
- [ ] **T093** [P] UpdateUserPreferences use case
...
- [ ] **T094** [P] CreateURLRedirect use case
...
- [ ] **T095** [P] HandleSlugChange use case
...
- [ ] **T095A** [P] Implement ContentPublishing state machine
...
- [ ] **T096** GET /v1/languages endpoint
...
- [ ] **T097** POST /v1/languages/detect endpoint
      - **Path**: backend/src/infrastructure/api/routes/languages.py
...
- [ ] **T098** GET /v1/content/{lang}/{slug} endpoint
...
- [ ] **T099** GET /v1/content/{lang} endpoint
      - **Path**: backend/src/infrastructure/api/routes/content.py
...
- [ ] **T100** GET /v1/currencies endpoint
...
- [ ] **T101** POST /v1/currencies/convert endpoint
      - **Path**: backend/src/infrastructure/api/routes/currencies.py
...
- [ ] **T102** GET /v1/user/preferences endpoint
...
- [ ] **T103** PUT /v1/user/preferences endpoint
      - **Path**: backend/src/infrastructure/api/routes/preferences.py
...
- [ ] **T104** [P] Pydantic request/response models for languages
...
- [ ] **T105** [P] Pydantic request/response models for content
...
- [ ] **T106** [P] Pydantic request/response models for currencies
...
- [ ] **T107** [P] Pydantic request/response models for preferences
...
- [ ] **T109** [P] LanguageSwitcher component
...
- [ ] **T110** [P] CurrencySelector component
...
- [ ] **T111** [P] LanguagePrompt component
...
- [ ] **T113** [P] SEOHead component (hreflang, schema)
...
- [ ] **T114** [P] ContentFallbackNotice component
...
- [ ] **T115** [P] Navigation component (multi-language aware)
...
- [ ] **T116** [P] Footer component (multi-language aware)
...
- [ ] **T117** [P] Price component (currency formatting)
...
- [ ] **T123** [P] API error handling utilities
...
- [ ] **T124** Configure next-intl middleware
...
- [ ] **T124A** [P] Configure next-intl message loading
...
- [ ] **T124B** [P] Create translation files for 3 languages
...
- [ ] **T125** Create [lang] dynamic segment layout
...
- [ ] **T126** Create root page (language detection)
...
- [ ] **T127** [P] Create home page per language
...
- [ ] **T128** [P] Create product listing page
...
- [ ] **T129** [P] Create product detail page
...
- [ ] **T130** Configure generateStaticParams for SSG
      - **Path**: frontend/src/app/[lang]/products/[slug]/page.tsx
...
- [ ] **T130A** [P] Configure ISR revalidate timing
      - **Path**: frontend/src/app/[lang]/products/[slug]/page.tsx
...
- [ ] **T131** Configure Strapi i18n plugin
...
- [ ] **T132** [P] Create Product content type with i18n
...
- [ ] **T133** [P] Create Page content type with i18n
...
- [ ] **T134** Configure webhook for content updates
...
- [ ] **T135** [P] Create custom admin panel translation status field
...
- [ ] **T136** Connect frontend to backend API (environment variables)
...
- [ ] **T137** Implement session ID generation middleware
...
- [ ] **T138** Connect backend to Strapi CMS (API token)
...
- [ ] **T139** Implement Redis session storage
...
- [ ] **T140** Configure CORS for all services
...
- [ ] **T141** Implement request logging middleware
...
- [ ] **T142** Implement error handling middleware
...
- [ ] **T143** Setup on-demand ISR revalidation endpoint
...
- [ ] **T144** Implement Strapi webhook handler
...
- [ ] **T146** Implement hreflang tag generation
...
- [ ] **T146A** [P] Generate x-default hreflang tag
...
- [ ] **T147** Implement schema markup generation
...
- [ ] **T147A** [P] Implement Organization schema
...
- [ ] **T148** Create sitemap generation API route
...
- [ ] **T148A** [P] Generate language-specific sitemaps
...
- [ ] **T149** Implement currency formatting utility (Intl.NumberFormat)
...
- [ ] **T150** Configure Tailwind RTL plugin
...
- [ ] **T150A** [P] Implement RTL utility classes
...
- [ ] **T151** [P] Unit tests for currency formatting
...
- [ ] **T152** [P] Unit tests for language detection logic
...
- [ ] **T153** [P] Unit tests for slug validation
...
- [ ] **T154** Run Lighthouse audits (>90 score) for all languages
      - **Path**: Manual testing or CI script
...
- [ ] **T154A** [P] Run API performance benchmarks
...
- [ ] **T155** Performance test page load <3s on 3G throttling
...
- [ ] **T155A** [P] Measure LCP, FCP, CLS (Web Vitals)
...
- [ ] **T156** Execute manual quickstart.md validation tests
      - **Path**: Manual testing following quickstart.md
...
- [ ] **T156A** [P] Run accessibility audit (WCAG 2.1 AA)
