...
- Violations: [Document any deviations with justification]
...
- [ ] Generic implementation over site-specific code
- Violations: [Document any deviations with justification]

**V. Integration Testing Priority**
- [ ] Tests planned for all new contracts
- [ ] Tests planned for inter-module communication
- [ ] Tests planned for shared schemas

**VI. API-First Design**
- [ ] API contracts defined before implementation
- [ ] Contract documents in /contracts/
- [ ] API versioning strategy defined
- [ ] Documentation plan in place

**VII. Performance & SEO Standards**
- [ ] Page load <3s target validated
- [ ] Lighthouse >90 score plan
- [ ] Schema markup planned for entities
- [ ] Multi-language SEO strategy (hreflang tags)
