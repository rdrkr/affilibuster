...
describe('ProductCategoriesMenu', () => {
  ...
  it('should render menu button link', () => {
    render(<ProductCategoriesMenu data={mockData} isActive={false} />)
  ...
  it('should apply active styling when isActive is true', () => {
    render(<ProductCategoriesMenu data={mockData} isActive={true} />)
    const link = screen.getByRole('link', { name: 'View all products' })
  ...
  it('should handle empty categories array', () => {
    ...
    render(<ProductCategoriesMenu data={dataWithNoCategories} isActive={false} />)
  ...
  it('should skip categories with null content', () => {
    ...
    render(<ProductCategoriesMenu data={dataWithNullContent} isActive={false} />)
