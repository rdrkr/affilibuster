 ...
 *   - Environment variables: THE_GREEN_BROTHER_PROTOCOL, THE_GREEN_BROTHER_PORT
 */
...
const hostname = process.env.THE_GREEN_BROTHER_HOSTNAME ?? 'localhost'
const bindHost = '0.0.0.0' // Bind to all interfaces for Docker healthchecks and networking
const port = parseInt(process.env.THE_GREEN_BROTHER_PORT ?? '3000', 10)
const protocol = process.env.THE_GREEN_BROTHER_PROTOCOL ?? 'http'
