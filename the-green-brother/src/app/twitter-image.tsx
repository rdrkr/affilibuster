...
/**
 * Dynamic Twitter image generator using Next.js metadata file convention.
...
/** Alt text for the Twitter card image. */
export const alt = 'TheGreenBrother - Sustainable Products'

/** Image dimensions for Twitter summary_large_image card (1200×630). */
export const size = {
  width: 1200,
  height: 630,
}
...
/**
 * Generate the Twitter card image for social sharing.
 * Fetches site title and description from CMS navigation data.
 * @returns ImageResponse with branded Twitter card image
 */
