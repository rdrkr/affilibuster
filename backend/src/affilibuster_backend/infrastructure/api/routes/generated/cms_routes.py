...
SINGLE_TYPE_CONFIGS: list[CMSSingleTypeConfig] = [
    ...
    CMSSingleTypeConfig(
        path="/consent",
        tag="consent",
        params_model=ConsentGetParametersQuery,
        response_model=ConsentGetResponse,
        description="Get consent page content from Strapi.",
    ),
    CMSSingleTypeConfig(
        path="/contact-us",
        tag="contact-us",
    ...
    CMSSingleTypeConfig(
        ...
        tag="content-type-builder-content-types",
        params_model=ContentTypeBuilderContentTypesGetParametersQuery,
        response_model=ContentTypeBuilderContentTypesGetResponse,
        description="Get content type builder content types content from Strapi.",
    ),
    CMSSingleTypeConfig(
        path="/cookie-policy",
        tag="cookie-policy",
        params_model=CookiePolicyGetParametersQuery,
        response_model=CookiePolicyGetResponse,
        description="Get Cookie Policy content from Strapi.",
    ),
    CMSSingleTypeConfig(
        path="/error-404",
        tag="error-404",
...
COLLECTION_CONFIGS: list[CMSCollectionConfig] = [
    ...
    CMSCollectionConfig(
        ...
        tag="consent-category",
        list_params_model=ConsentCategoriesGetParametersQuery,
        list_response_model=ConsentCategoriesGetResponse,
        item_params_model=ConsentCategoriesIdGetParametersQuery,
        item_response_model=ConsentCategoriesIdGetResponse,
        id_description="Consent Category ID or slug",
        list_description="List all consent categorys from Strapi.",
        item_description="Get a specific consent category by ID or slug.",
    ),
    CMSCollectionConfig(
    ...
    CMSCollectionConfig(
        path="/upload-files",
        tag="upload-file",
        list_params_model=UploadFilesGetParametersQuery,
        list_response_model=UploadFilesGetResponse,
        item_params_model=UploadFilesIdGetParametersQuery,
        item_response_model=UploadFilesIdGetResponse,
        id_description="Upload File ID or slug",
        list_description="List all upload files from Strapi.",
        item_description="Get a specific upload file by ID or slug.",
    ),
]
