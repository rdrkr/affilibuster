...
from infrastructure.database.models.content import ContentModel
from infrastructure.database.models.content_version import ContentVersionModel
from infrastructure.database.models.currency import CurrencyModel
from infrastructure.database.models.language import LanguageModel
from infrastructure.database.models.locale import LocaleModel
from infrastructure.database.models.url_route import URLRedirectModel, URLRouteModel
...
class TestDatabaseModelRepr:
    ...
    def test_content_model_repr(self):
        ...
        model = ContentModel(id=uuid4(), type="page", status="draft", created_by="user-123", updated_by="user-123")
        repr_str = repr(model)
