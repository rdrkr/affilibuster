...
class TestRedisCacheServiceInitialization:
    ...
    def test_initialization_with_default_url(self):
        ...
        with patch("infrastructure.cache.redis_cache.settings") as mock_settings:
...
class TestGetClient:
    ...
    async def test_get_client_creates_new_client(self):
        ...
        with patch("infrastructure.cache.redis_cache.redis.from_url", new_callable=AsyncMock) as mock_from_url:
...
class TestGet:
    ...
    async def test_get_returns_value_for_existing_key(self):
        ...
        with patch(
            "infrastructure.cache.redis_cache.redis.from_url",
