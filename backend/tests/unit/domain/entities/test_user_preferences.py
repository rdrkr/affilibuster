...
class TestUserPreferencesCreation:
    ...
    def test_create_user_preferences_minimal(self):
        ...
        prefs = UserPreferences(session_id="session-abc-123", selected_currency="USD")
    ...
    def test_auto_generated_id(self):
        ...
        prefs = UserPreferences(session_id="session-123", selected_currency="USD")
    ...
    def test_different_currencies(self):
        ...
        for currency in currencies:
            prefs = UserPreferences(session_id="session-123", selected_currency=currency)
...
class TestUserPreferencesValidation:
    ...
    def test_error_when_session_id_empty(self):
        ...
        with pytest.raises(ValueError, match="sessionId is required"):
            UserPreferences(session_id="", selected_currency="USD")  # Empty string
...
class TestUserPreferencesGetEffectiveIdentifier:
    ...
    def test_get_effective_identifier_returns_session_id_when_no_user_id(self):
        ...
        prefs = UserPreferences(session_id="session-abc-123", selected_currency="USD", user_id=None)
    ...
    def test_get_effective_identifier_returns_user_id_when_present(self):
        ...
        prefs = UserPreferences(session_id="session-abc-123", selected_currency="USD", user_id="user-456")
    ...
    def test_user_id_takes_precedence_over_session_id(self):
        ...
        prefs = UserPreferences(session_id="session-xyz-789", selected_currency="USD", user_id="user-123")
...
class TestUserPreferencesEdgeCases:
    ...
    def test_detected_language_optional(self):
        ...
        prefs = UserPreferences(session_id="session-123", selected_currency="USD", detected_language=None)

        assert prefs.detected_language is None

    def test_detected_language_can_be_set(self):
        """Test that detected_language can be set during creation."""
        prefs = UserPreferences(session_id="session-123", selected_currency="USD", detected_language="fr")
    ...
    def test_session_id_with_special_characters(self):
        ...
        prefs = UserPreferences(session_id=special_session_id, selected_currency="USD")
    ...
    def test_currency_update_workflow(self):
        ...
        prefs = UserPreferences(session_id="session-123", selected_currency="USD", detected_language="en")
