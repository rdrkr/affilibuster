...
**Rationale**: Supports the project's scaling goals (API-first architecture, headless CMS option) and enables the-green-brother flexibility across different affiliate sites.
